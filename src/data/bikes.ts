...
export const bikes: BikeMeta[] = [
  ...
  { slug: 'principia-evolution', year: '2007', place: 'Danmark', title: 'Principia Evolution', text: 'En dansk aluminiumsracer med store formede rør, WEAVE-kulfibergaffel og Dura-Ace-komponenter fra årene omkring Principias ejerskifte.', image: 'images/bikes/principia-evolution/hero.webp' },
