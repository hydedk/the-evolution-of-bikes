...
export const stories: StoryMeta[] = [
  ...
  { slug: 'skibby-koppenberg-1987', type: 'historie', year: '1987', title: 'Da løbsbilen kørte over Skibbys cykel', text: 'I Flandern Rundt 1987 førte Jesper Skibby alene på Koppenberg, da en officiel følgebil kørte over hans cykel.', image: 'images/stories/skibby-koppenberg-1987/illustration.webp', periods: ['1980-1990'], topics: ['flandern-rundt', 'koppenberg', 'dansk-cykling', 'brosten'], relatedBikes: [], relatedComponents: [] },
  { slug: 'festina-sagen-tour-de-france-1998', type: 'historie', year: '1998', title: 'Da Festina-sagen fik Tour de France til at gå i opløsning', text: 'En bil fuld af dopingmidler blev standset før Touren. Tre uger senere var et hold udelukket, rytterne i protest og feltet næsten halveret.', image: 'images/stories/festina-tour-1998/illustration.webp', periods: ['1990-2000'], topics: ['tour-de-france', 'doping', 'rytterprotest'], relatedBikes: [], relatedComponents: [] },
  { slug: 'ivo-faltoni-mekaniker-giro-1954', type: 'historie', year: '1954', title: 'Den 16-årige mekaniker, der blev to år ældre på én nat', text: 'Ivo Faltoni var 16, dygtig til at bygge hjul og for ung til Giroens servicekaravane. Et falsk dokument gjorde ham atten på papiret.', image: 'images/stories/ivo-faltoni-giro-1954/illustration.webp', periods: ['1940-1950'], topics: ['giro-ditalia', 'mekanikere', 'hjulbygning'], relatedBikes: [], relatedComponents: [] },
