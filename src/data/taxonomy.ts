...
export const periods = [
  ['1800-1899', 'Fra de første løb – 1899', 'From the first races to 1899'], ['1900-1920', '1900–1920', '1900–1920'],
...
const storyClassifications: Record<string, Classification> = {
  ...
  'da-pulsen-kom-med-ud-paa-landevejen': { period: '1980-1989', primary: 'kost-traening-og-videnskab', secondary: ['teknik', 'samfund-og-tidsaand'] },
  'peppino-drali-bianchi-ved-filebaenken': { period: '1970-1979', primary: 'menneskene-bag', secondary: ['teknik', 'cykelkultur'] },
  'da-pastaen-overtog-morgenbordet': { period: '1980-1989', primary: 'kost-traening-og-videnskab', secondary: ['cykelkultur', 'menneskene-bag'] },
  ...
  'moser-timerekord-1984': { period: '1980-1989', primary: 'teknik', secondary: ['loeb-og-store-oejeblikke', 'kost-traening-og-videnskab'] },
  'look-klikpedal-hinault-1985': { period: '1980-1989', primary: 'teknik', secondary: ['ryttere', 'cykelkultur'] },
  'gavia-sneetapen-1988': { period: '1980-1989', primary: 'loeb-og-store-oejeblikke', secondary: ['ryttere', 'menneskene-bag'] },
  'lemond-fignon-otte-sekunder-1989': { period: '1980-1989', primary: 'loeb-og-store-oejeblikke', secondary: ['teknik', 'ryttere'] },
  'boonen-paris-roubaix-2009': { period: '2000-2009', primary: 'loeb-og-store-oejeblikke', secondary: ['ryttere', 'teknik'] },
  'operacion-puerto-2006': { period: '2000-2009', primary: 'samfund-og-tidsaand', secondary: ['kost-traening-og-videnskab', 'loeb-og-store-oejeblikke'] },
  'bjarne-riis-team-csc': { period: '2000-2009', primary: 'menneskene-bag', secondary: ['samfund-og-tidsaand', 'kost-traening-og-videnskab'] },
  'carbon-og-68-kilo': { period: '2000-2009', primary: 'teknik', secondary: ['menneskene-bag', 'samfund-og-tidsaand'] },
  'froome-finestre-2018': { period: '2010-2019', primary: 'loeb-og-store-oejeblikke', secondary: ['ryttere', 'kost-traening-og-videnskab'] },
  'tignes-etapen-stoppet-2019': { period: '2010-2019', primary: 'loeb-og-store-oejeblikke', secondary: ['samfund-og-tidsaand', 'ryttere'] },
  'gilbert-flandern-rundt-2017': { period: '2010-2019', primary: 'loeb-og-store-oejeblikke', secondary: ['ryttere'] },
  'sram-etap-traadloese-gear': { period: '2010-2019', primary: 'teknik', secondary: ['menneskene-bag', 'cykelkultur'] },
...
export type ContentItem = {
  ...
  period: string; periods: string[]; primaryTheme: ThemeId; secondaryThemes: ThemeId[]; themes: ThemeId[];
...
export const contentItems: ContentItem[] = [
  ...
  ...bikes.map((bike) => {
    ...
    return { id: bike.slug, type: 'cykel' as const, year: bike.year, sortYear: numberFrom(bike.year), title: bike.title, text: bike.text, period, periods: [period], primaryTheme: 'teknik' as const, secondaryThemes: ['cykelkultur'] as ThemeId[], themes: ['teknik', 'cykelkultur'] as ThemeId[], canonicalUrl: `/cykler/${bike.slug}/`, englishUrl: `/en/bikes/${bike.slug}/`, image: `/${bike.image}` };
  }),
  ...components.map((component) => ({ id: component.slug, type: 'komponent' as const, year: component.year, sortYear: numberFrom(component.year), title: component.title, text: component.text, period: component.period, periods: [component.period], primaryTheme: 'teknik' as const, secondaryThemes: [] as ThemeId[], themes: ['teknik'] as ThemeId[], canonicalUrl: `/komponenter/${component.slug}/`, englishUrl: `/en/components/${component.slug}/` })),
];

export const contentForPeriod = (period: string) => contentItems.filter((item) => item.periods.includes(period));
